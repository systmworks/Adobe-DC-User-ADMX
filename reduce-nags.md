...
Suggested **Group Policy** states to reduce onboarding prompts, tooltips, upsells, and similar UI noise in the v1.4 user (`HKCU`) ADMX templates. Rows come from the **GoodSetting** column in the preference source for non-security categories.
